...
#define DEF_WAIT_EVENT_DATA_READY				pdMS_TO_TICKS(5000UL)
#define DEF_WAIT_MSG_BUFFER_SEND_DATAPACKGE		pdMS_TO_TICKS(200)

#define DEF_WAIT_MSG_BUFFER_RECV_UPLINK			(DEF_DELAY_TASK_SEND_DATAPACKAGE + pdMS_TO_TICKS(100UL))
