...
#define DEF_BIT_MEASURE_START_HUM_TEMP			(1 << 1)
#define DEF_BIT_MEASURE_START_SERVO				(1 << 2)
#define DEF_BIT_MEASURE_START					(DEF_BIT_MEASURE_START_CO2 | DEF_BIT_MEASURE_START_HUM_TEMP | DEF_BIT_MEASURE_START_SERVO)
...
#define DEF_BIT_DATA_READY						(DEF_BIT_DATA_READY_CO2 | DEF_BIT_DATA_READY_HUM_TEMP | DEF_BIT_DATA_READY_SERVO)
...
#define DEF_PROPORTIONAL_GAIN_TEMP				2			
